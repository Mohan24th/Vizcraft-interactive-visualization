...
from app.routes import upload, visualize, insights ,ai_insights, ai_chart_recommendations, analysis ,nl_visualization
...
app.include_router(nl_visualization.router, prefix="/nl-visualization")
